        ...
        <div className="min-h-screen bg-background flex items-center justify-center p-4 sm:p-6 lg:p-8 animate-fade-in font-sans">
            <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="pt-4">
                            <button
                                type="submit"
                                disabled={loader}
                                className="w-full h-14 bg-brand text-white font-extrabold rounded-2xl shadow-lg hover:bg-brandDark hover:shadow-xl hover:-translate-y-1 active:scale-[0.98] transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                            >
                                {loader ? (
                ...
                <div className="hidden lg:flex flex-col items-center justify-center text-center p-12 bg-surface/40 border border-black/5 rounded-[40px] h-full min-h-[600px] animate-fade-in relative overflow-hidden group">
                    ...
                    <div className="absolute bottom-0 left-0 w-64 h-64 bg-brand/10 rounded-full translate-y-1/2 -translate-x-1/2 blur-3xl"></div>
